    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
        {
            ...
            var solution = new AdhocWorkspace()
                ...
                .AddMetadataReference(projectId, MetadataReference.CreateFromFile(typeof(IDbConnection).Assembly.Location))
                .AddMetadataReference(projectId, MetadataReference.CreateFromFile(typeof(SqlMapper).Assembly.Location));
